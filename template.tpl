...
var trackerURL = "https://" + data.cdnDomain + "/" + data.subDomain + data.matomoDomain + "/matomo.js";
...
if(data.enableJSErrorTracking) {
  paq(["enableJSErrorTracking"]);// A revoir
}

if(data.overridePageReferrer) {
  paq(["setReferrerUrl", data.newPageReferrer]); // où l'identifier ?
}
