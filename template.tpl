...
[
  ...
  {
    "type": "CHECKBOX",
    "name": "initializeMatomo",
    "checkboxText": "Do not initialize Matomo",
    "simpleValueType": true,
    "help": "Integrating manually Matomo on your website will allow you to change the URL and bypass adblockers."
  },
  {
    "type": "GROUP",
